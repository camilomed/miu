	...
	public static void main (String[ ]args) {
		...
		int arr4[] = new int[size];
		 ...
		 System.out.println(Arrays.toString(arr4));
			...
			int arr5[] = new int[10];
			 System.arraycopy(arr, 1, arr5, 5, 2);
			 ...
			 arr6 = Arrays.copyOfRange(arr, 2, 10);      
	        ...
	        System.out.println("Traversing list through for loop:");  
	           ...
	           al.removeIf(x -> x.contains("Ajay"));   //Here, we are using Lambda expression   
