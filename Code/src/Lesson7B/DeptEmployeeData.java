...
public class DeptEmployeeData {
	...
	public static void main(String args[]) {
		...
		Arrays.sort(data, ob.getNameComparator());
		System.out.println("Comparator as Inner class sort by name");
		for(DeptEmployee e : data) {
			System.out.println(e);
		}
	}
	private class DeptNameComparator implements Comparator<DeptEmployee>{
		@Override
	...
	private DeptNameComparator getNameComparator() {
		return new DeptNameComparator();
	}
}
